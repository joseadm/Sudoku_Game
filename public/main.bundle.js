...
module.exports = "\n    <h3>{{titulo}}</h3>\n    <div class=\"container wrapper\">\n            <div class=\"row\">\n                        <div *ngIf=\"alertRegister\" class=\"alert alert-info\">\n                                         {{alertRegister}}\n                                      </div>\n                <div class=\"col-12\" align=\"center\">\n                    <button type=\"button\" class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#myModal\">\n                        Nuevo\n                      </button>\n                      \n                      <!-- Modal -->\n                      <div class=\"modal fade\" id=\"myModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\">\n                        <div class=\"modal-dialog\" role=\"document\">\n                          <div class=\"modal-content\">\n                            <div class=\"modal-header\">\n                              <h5 class=\"modal-title\" id=\"exampleModalLabel\">Elige la dificultad</h5>\n                              <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n                                <span aria-hidden=\"true\">&times;</span>\n                              </button>\n                            </div>\n                            <div class=\"modal-body\">\n                                  <div class=\"row\">\n                                    <div class=\"col-4\"><p>Esta dificultad permite aprender a los jugadores sin nada de experiencia</p><a href=\"#\" class=\"btn btn-success\" (click) = \"getGridDifficulty('Easy')\" data-dismiss=\"modal\">Facil</a></div>\n                                    <div class=\"col-4\"><p>Permite a los jugadores con habilidad aprender a analizar</p><a href=\"#\" class=\"btn btn-warning\" (click) = \"getGridDifficulty('Medium')\" data-dismiss=\"modal\">Medio</a></div>\n                                    <div class=\"col-4\"><p>Una modalidad mas dificil para los jugadores mas expertos y habilidosos</p><a href=\"#\" class=\"btn btn-danger\" (click) = \"getGridDifficulty('Hard')\" data-dismiss=\"modal\">Dificil</a></div>                                    \n                                  </div>\n                                  </div>\n                                  <div class=\"modal-footer\">\n                                      <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Cerrar</button>\n                                    </div>\n                            </div>\n                          </div>\n                        </div>\n\n                        <button type=\"button\" class=\"btn btn-success\" (click) = \"insertGame()\">Guardar</button>\n                        <button type=\"button\" class=\"btn btn-warning\" (click) = \"getGame()\">Cargar</button>     \n                        <button type=\"button\" class=\"btn btn-danger\" (click) = \"rSolve()\">Resolver</button>\n                </div>\n                    <div class=\"col-12\" align=\"center\">\n                            <br>\n                            <div id=\"sudokuGrid\"></div><br><br>\n\n</div>\n<br><br>\n</div>\n</div>\n\n\n    "
